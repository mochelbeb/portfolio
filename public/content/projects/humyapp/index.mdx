...
<div className="grid gap-1 sm:grid-cols-2 [&_*]:m-0">
  <img
    src="/content/projects/humyapp/3.png"
    alt="Order"
    className="row-span-2 h-full object-cover"
  />
  <img src="/content/projects/humyapp/4.png" alt="Coupon form" />
  <img src="/content/projects/humyapp/2.png" alt="Permission checkboxes form" />
  <img src="/content/projects/humyapp/5.png" alt="Driver details" />
  <img src="/content/projects/humyapp/1.png" alt="Q&A list" />
</div>
