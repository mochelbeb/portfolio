...
summary: Did you know that you can create your own iterable objects (can be used in a for...of loop) in JavaScript?
tags: JavaScript,Data Structure
publishedAt: 2023-12-03
---

**In this post we are going to build a linked list in JavaScript that is iterable, which means it can be used in a `for...of` or by anything that takes an iterable**
...
What makes a type or an object iterable? again from MDN:
