...
export const Footer: FC<FooterProps> = ({}) => {
  return (
    <footer className="[&a]:hover:underline bg-gray-950 mt-10">
      <div className="container flex flex-wrap items-center p-4 gap-1 justify-center sm:justify-between mx-auto ">
        ...
        <div className="flex justify-center space-x-4 lg:mt-0 [&>a>svg]:w-7 [&>a>svg]:h-7">
